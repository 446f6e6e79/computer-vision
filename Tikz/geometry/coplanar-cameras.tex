...
% Camera centers
% ------------------------------------------------
\node[point, label=below left:{${}^{W}O_L=0$}] at (Cl) {};
\node[point, label=below right:{$O_R$}] at (Cr) {};

% ------------------------------------------------
% World point and projection rays
% ------------------------------------------------
\node[point, label=above right:{${}^{W}\boldsymbol{P}\left({}^{W}P_x,{}^{W}P_y,{}^{W}P_z\right)$}] at (WP) {};
\draw[thick] (Cl) -- (WP);
\draw[thick] (Cr) -- (WP);
...
\node[above left] at (Pl) {${}^{L}p_x$};
\node[below] at (Pr) {${}^{R}p_x$};
...
\draw[measure] (Cl) ++(0,-0.88) -- node[below] {${}^{L}P_x$} ($(WBase)+(0,-0.88)$);
\draw[measure] (Cr) ++(0,-1.35) -- node[below] {${}^{R}P_x$} ($(WBase)+(0,-1.35)$);
\draw[decorate, decoration={brace, mirror, amplitude=7pt}]
    ($(Cl)+(0,-1.85)$) -- node[below=9pt] {${}^{W}P_x$} ($(WBase)+(0,-1.85)$);
