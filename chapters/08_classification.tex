...
To optimize detection speed, Viola-Jones uses a sequence (cascade) of binary classifiers. 
Each stage analyzes an image window; if a classifier predicts "non-object," the window is immediately discarded. 
This early rejection of negative samples drastically reduces overall computational cost.