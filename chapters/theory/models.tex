...
if the distance between the camera and the image plane obeys the \texttt{thin lens equation}.
...
\begin{equation*}
    Z' (f + Z) = fZ + f^2
\end{equation*}
Where $Z = u - f$ and $Z' = v - f$. Substituting these values into the previous equation, we end up with the \texttt{thin lens equation}:
\begin{equation}
