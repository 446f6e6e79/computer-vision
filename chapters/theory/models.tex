...
If we move the image plane, the point $P'$ will be projected to a different point on the image plane, which means that the objects in the scene will be out of focus.
...
If the objects are not on focus, typical issues that arise are:\
\begin{itemize}
